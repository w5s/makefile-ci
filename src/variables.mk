...
ifneq ($(CI_REGISTRY),)
.__CI_REGISTRY_IMAGE_RAW = $(CI_REGISTRY)/$(CI_PROJECT_PATH)
else
.__CI_REGISTRY_IMAGE_RAW = $(CI_PROJECT_PATH)
endif
# lower case by default
.CI_REGISTRY_IMAGE_DEFAULT = $(shell echo $(.__CI_REGISTRY_IMAGE_RAW) | tr '[:upper:]' '[:lower:]')
